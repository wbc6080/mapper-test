...
import (
	...
	"github.com/kubeedge/mapper-framework/test/pkg/common"
	dmiapi "github.com/kubeedge/mapper-framework/test/pkg/dmi-api"
	"github.com/kubeedge/mapper-framework/test/pkg/util/parse"
)
